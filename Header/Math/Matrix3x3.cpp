...
Matrix3x3 Matrix3x3::Transpose() {
	return Matrix3x3{this->m[0][0], this->m[1][0], this->m[2][0], this->m[0][1], this->m[1][1],
	                 this->m[2][1], this->m[0][2], this->m[1][2], this->m[2][2]};
}
...
Matrix3x3 Matrix3x3::operator*(const Matrix3x3& Second) const {
	...
	return (Matrix3x3{
	    this->m[0][0] * Second.m[0][0] + this->m[0][1] * Second.m[1][0] +
	        this->m[0][2] * Second.m[2][0],
	    this->m[0][0] * Second.m[0][1] + this->m[0][1] * Second.m[1][1] +
	        this->m[0][2] * Second.m[2][1],
	    this->m[0][0] * Second.m[0][2] + this->m[0][2] * Second.m[1][2] +
	        this->m[0][2] * Second.m[2][2],

	    this->m[1][0] * Second.m[0][0] + this->m[1][1] * Second.m[1][0] +
	        this->m[1][2] * Second.m[2][0],
	    this->m[1][0] * Second.m[0][1] + this->m[1][1] * Second.m[1][1] +
	        this->m[1][2] * Second.m[2][1],
	    this->m[1][0] * Second.m[0][2] + this->m[1][2] * Second.m[1][2] +
	        this->m[1][2] * Second.m[2][2],

	    this->m[2][0] * Second.m[0][0] + this->m[2][1] * Second.m[1][0] +
	        this->m[2][2] * Second.m[2][0],
	    this->m[2][0] * Second.m[0][1] + this->m[2][1] * Second.m[1][1] +
	        this->m[2][2] * Second.m[2][1],
	    this->m[2][0] * Second.m[0][2] + this->m[2][2] * Second.m[1][2] +
	        this->m[2][2] * Second.m[2][2],
	});
}
